...
func (a *api) Initialize() error {
	entities := []system.SysApi{
		...
		{ApiGroup: "全局配置", Method: "POST", Path: "/config/createConfig", Description: "新增全局配置"},
		{ApiGroup: "全局配置", Method: "GET", Path: "/config/getConfigById", Description: "通过ID获取全局配置"},
		{ApiGroup: "全局配置", Method: "GET", Path: "/config/getConfigByName", Description: "通过Name获取全局配置"},
		{ApiGroup: "全局配置", Method: "GET", Path: "/config/getConfigList", Description: "获取全局配置列表"},
		{ApiGroup: "全局配置", Method: "DELETE", Path: "/config/deleteConfig", Description: "删除全局配置"},
		{ApiGroup: "全局配置", Method: "DELETE", Path: "/config/deleteConfigByIds", Description: "批量删除全局配置"},
		{ApiGroup: "全局配置", Method: "GET", Path: "/config/getAllConfig", Description: "获取所有全局配置"},
		{ApiGroup: "全局配置", Method: "PUT", Path: "/config/updateConfig", Description: "更新全局配置"},

		{ApiGroup: "接口管理", Method: "POST", Path: "/testcase/createTestCase", Description: "新增接口"},
		{ApiGroup: "接口管理", Method: "PUT", Path: "/testcase/updateTestCase", Description: "更新接口"},
		{ApiGroup: "接口管理", Method: "DELETE", Path: "/testcase/deleteTestCaseByIds", Description: "批量删除"},
		{ApiGroup: "接口管理", Method: "DELETE", Path: "/testcase/deleteTestCase", Description: "普通删除"},
		{ApiGroup: "接口管理", Method: "DELETE", Path: "/testcase/deleteTestStepByIds", Description: "批量删除step"},
		{ApiGroup: "接口管理", Method: "DELETE", Path: "/testcase/deleteTestStep", Description: "普通删除"},
		{ApiGroup: "接口管理", Method: "GET", Path: "/testcase/getTestCase", Description: "获取case信息"},
		{ApiGroup: "接口管理", Method: "GET", Path: "/testcase/runTestCase", Description: "运行测试"},
		{ApiGroup: "接口管理", Method: "GET", Path: "/testcase/getTestCaseList", Description: "获取case列表"},
