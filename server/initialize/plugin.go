...
import (
	...
	//"github.com/yunfei07/lemon/server/plugin/email" // 本地插件仓库地址模式
	"github.com/yunfei07/lemon/server/plugin/example_plugin"
	"github.com/yunfei07/lemon/server/utils/plugin"
